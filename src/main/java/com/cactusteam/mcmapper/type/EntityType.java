...
import com.cactusteam.mcmapper.specific.entity.Projectile;
...
public enum EntityType {
    ...
    ARROW("Arrow", "arrow", new Projectile("arrow")),
    ...
    EGG("Egg", "egg", new Projectile("egg")),
    ...
    ENDER_PEAR("Ender Pear", "ender_pear", new Projectile("ender_pear")),
    ...
    EXPERIENCE_BOTTLE("Experience Bottle", "experience_bottle", new Projectile("experience_bottle")),
    EXPERIENCE_ORB("Experience Orb", "experience_orb", new Entity("experience_orb")),
    EYE_OF_ENDER("Eye of Ender", "eye_of_ender", new Projectile("eye_of_ender")),
    FALLING_BLOCK("Falling Block", "falling_block", new Entity("falling_block")),
    FIREBALL("Fireball", "fireball", new Projectile("fireball")),
    ...
    POTION("Potion", "potion", new Projectile("potion")),
    ...
    SMALL_FIREBALL("Small Fireball", "small_fireball", new Projectile("small_fireball")),
    SNIFFER("Sniffer", "sniffer", new Mob("sniffer")),
    SNOWBALL("Snowball", "snowball", new Projectile("snowball")),
    ...
    SPECTRAL_ARROW("Spectral Arrow", "spectral_arrow", new Projectile("spectral_arrow")),
    ...
    TRIDENT("Trident", "trident", new Projectile("trident")),
